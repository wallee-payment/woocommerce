...
<ul class="woocommerce-order-admin-wallee-downloads">
	...
	public static function download_document() {
		...
		$action = isset( $_GET['wallee_admin'] ) ? sanitize_key( wp_unslash( $_GET['wallee_admin'] ) ) : null;
	...
	private static function is_download_request() {
		return ( isset( $_GET['post'] ) && isset( $_GET['wallee_admin'] ) && isset( $_GET['nonce'] ) ); // phpcs:ignore
	}
}
