...
final class WC_Wallee_Blocks_Support extends AbstractPaymentMethodType {
	...
	public function initialize() {
		$this->settings['space_id'] = get_option( WooCommerce_Wallee::CK_SPACE_ID );
	}
	...
	public function get_payment_method_script_handles() {
		...
		return [ 'WooCommerce_Wallee_blocks_support' ];
	}
	...
	static public function get_payment_methods() {
		...
		$payments_list = array_map(function(WC_Wallee_Gateway $payment_gateway) {
			return [
				...
				'integration_mode' => (get_option( WooCommerce_Wallee::CK_INTEGRATION ) == WC_Wallee_Integration::LIGHTBOX ) ? 'lightbox' : 'iframe',
