...
class WC_Wallee_Webhook_Strategy_Manager {
	 ...
	 *
	 * @var WC_Wallee_Webhook_Strategy_Manager
	 */
	...
	public function __construct() {
		$this->webhook_service = WC_Wallee_Service_Webhook::instance();
		$this->helper = WC_Wallee_Helper::instance();
	...
	private function configure_strategies_to_handle_webhooks() {
		$this->strategies[] = new WC_Wallee_Webhook_Manual_Task_Strategy();
		$this->strategies[] = new WC_Wallee_Webhook_Method_Configuration_Strategy();
		$this->strategies[] = new WC_Wallee_Webhook_Transaction_Strategy();
		$this->strategies[] = new WC_Wallee_Webhook_Delivery_Indication_Strategy();
		$this->strategies[] = new WC_Wallee_Webhook_Transaction_Invoice_Strategy();
		$this->strategies[] = new WC_Wallee_Webhook_Transaction_Completion_Strategy();
		$this->strategies[] = new WC_Wallee_Webhook_Transaction_Void_Strategy();
		$this->strategies[] = new WC_Wallee_Webhook_Refund_Strategy();
		$this->strategies[] = new WC_Wallee_Webhook_Token_Strategy();
		$this->strategies[] = new WC_Wallee_Webhook_Token_Version_Strategy();
	}
	 ...
	 *
	 * @param WC_Wallee_Webhook_Request $request The incoming webhook request.
	 * @return WC_Wallee_Webhook_Strategy_Interface The strategy to handle the request.
	 ...
	 * throws an exception.
	 *
	 * @param WC_Wallee_Webhook_Request $request The incoming webhook request object.
