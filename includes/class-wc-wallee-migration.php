...
class WC_Wallee_Migration {
	...
	public static function plugin_row_meta( $links, $file ) {
		if ( WC_WALLEE_PLUGIN_BASENAME === $file ) {
			$row_meta = array(
				'docs' => '<a href="https://plugin-documentation.wallee.com/wallee-payment/woocommerce/3.3.19/docs/en/documentation.html" aria-label="' . esc_html__( 'View Documentation', 'woo-wallee' ) . '">' . esc_html__( 'Documentation', 'woo-wallee' ) . '</a>',
			);
