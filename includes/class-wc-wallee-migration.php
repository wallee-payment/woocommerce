...
class WC_Wallee_Migration {
	...
	public static function plugin_row_meta( $links, $file ) {
		if ( WC_WALLEE_PLUGIN_BASENAME === $file ) {
			$row_meta = array(
				'docs' => '<a href="https://plugin-documentation.wallee.com/wallee-payment/woocommerce/3.1.0/docs/en/documentation.html" aria-label="' . esc_html__( 'View Documentation', 'woo-wallee' ) . '">' . esc_html__( 'Documentation', 'woo-wallee' ) . '</a>',
			);
	...
	public static function update_1_0_6_shorten_table_names() {
		...
		$table_rename_map = array(
			"{$wpdb->prefix}woocommerce_wallee_attribute_options" => "{$wpdb->prefix}wallee_attribute_options",
			"{$wpdb->prefix}woocommerce_wallee_completion_job" => "{$wpdb->prefix}wallee_completion_job",
			"{$wpdb->prefix}woocommerce_wallee_method_configuration" => "{$wpdb->prefix}wallee_method_config",
			"{$wpdb->prefix}woocommerce_wallee_refund_job" => "{$wpdb->prefix}wallee_refund_job",
			"{$wpdb->prefix}woocommerce_wallee_token_info" => "{$wpdb->prefix}wallee_token_info",
			"{$wpdb->prefix}woocommerce_wallee_transaction_info" => "{$wpdb->prefix}wallee_transaction_info",
			"{$wpdb->prefix}woocommerce_wallee_void_job" => "{$wpdb->prefix}wallee_void_job",
		);
