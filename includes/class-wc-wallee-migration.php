...
class WC_Wallee_Migration {
	...
	private static function check_requirements() {
		...
		if ( ! empty( $errors ) ) {
			...
			$message = printf(
				...
				esc_html__( 'Please check the following requirements before activating:', 'woo-wallee' ),
				esc_html__( $error_list ) //phpcs:ignore
			);
			// phpcs:ignore
			wp_die( $message, esc_html__( 'Could not activate plugin wallee.', 'woo-wallee' ), array( 'back_link' => true ) );
			return;
		}
	}
	...
	public static function plugin_row_meta( $links, $file ) {
		if ( WC_WALLEE_PLUGIN_BASENAME === $file ) {
			$row_meta = array(
				'docs' => '<a href="https://plugin-documentation.wallee.com/wallee-payment/woocommerce/3.1.2/docs/en/documentation.html" aria-label="' . esc_html__( 'View Documentation', 'woo-wallee' ) . '">' . esc_html__( 'Documentation', 'woo-wallee' ) . '</a>',
			);
