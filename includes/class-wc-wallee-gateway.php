...
<?php
	...
	public function process_payment($order_id){
	    ...
	    $space_id = sanitize_text_field($_POST['wallee-space-id-'.$this->id]);
	    $transaction_id = sanitize_text_field($_POST['wallee-transaction-id-'.$this->id]);
	    $transaction_nonce = sanitize_text_field($_POST['wallee-transaction-nonce-'.$this->id]);
