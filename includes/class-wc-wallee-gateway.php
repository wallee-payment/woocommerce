...
<tr valign="top">
	...
	public function payment_fields() {
		...
		try {
			...
			if ( ! wp_script_is( 'wallee-remote-checkout-js', 'enqueued' ) ) {
				...
				//wp_add_inline_script( 'wallee-checkout-js', 'jQuery(document).ready (function (){ wc_wallee_checkout.init(); });' );
	...
	public function process_payment( $order_id ) {
		...
		try {
			...
			$url = apply_filters( 'wc_wallee_success_url', $gateway->get_return_url( $order ), $order );
			$result = array(
				'result' => 'success',
				'wallee' => 'true',
				'redirect' => $url
