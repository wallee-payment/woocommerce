...
class WC_Wallee_Entity_Refund_Job extends WC_Wallee_Entity_Abstract {
	...
	const WALLEE_STATE_PENDING = 'pending';
	const WALLEE_STATE_SUCCESS = 'success';
	const WALLEE_STATE_FAILURE = 'failure';
	...
	protected static function get_field_definition() {
		return array(
			'external_id' => WC_Wallee_Entity_Resource_Type::WALLEE_STRING,
			...
			'wc_refund_id' => WC_Wallee_Entity_Resource_Type::WALLEE_INTEGER,
			'refund' => WC_Wallee_Entity_Resource_Type::WALLEE_OBJECT,
	...
	public static function count_running_refund_for_transaction( $space_id, $transaction_id ) {
		...
		$result = $wpdb->get_var( //phpcs:ignore
			$wpdb->prepare(
				...
				$space_id,
				$transaction_id,
				self::WALLEE_STATE_SUCCESS,
				self::WALLEE_STATE_FAILURE
			)
		);
		// phpcs:enable WordPress.DB.DirectDatabaseQuery.SchemaChange, WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching, WordPress.DB.PreparedSQL.InterpolatedNotPrepared, WordPress.DB.PreparedSQLPlaceholders.UnfinishedPrepare.
		return $result;
