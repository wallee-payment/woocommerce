...
/**
 * Class WC_Wallee_Entity_Abstract.
 * Abstract implementation of a entity
 *
 * @class WC_Wallee_Entity_Abstract
 */
abstract class WC_Wallee_Entity_Abstract {
	/**
	 * Data
	 *
	 * @var $data data.
	...
	protected static function get_base_fields() {
		return array(
			...
			'created_at' => WC_Wallee_Entity_Resource_Type::WALLEE_DATETIME,
			'updated_at' => WC_Wallee_Entity_Resource_Type::WALLEE_DATETIME,
		);
	}
	...
	protected function fill_values_from_db( array $db_values ) {
		...
		foreach ( $fields as $key => $type ) {
			if ( isset( $db_values[ $key ] ) ) {
				$value = $db_values[ $key ];
				switch ( $type ) {
					case WC_Wallee_Entity_Resource_Type::WALLEE_STRING:
						// Do nothing.
						break;
					case WC_Wallee_Entity_Resource_Type::WALLEE_BOOLEAN:
						$value = 'Y' === $value;
						break;
					case WC_Wallee_Entity_Resource_Type::WALLEE_INTEGER:
						$value = intval( $value );
						break;

					case WC_Wallee_Entity_Resource_Type::WALLEE_DECIMAL:
						$value = (float) $value;
						break;

					case WC_Wallee_Entity_Resource_Type::WALLEE_DATETIME:
						$value = new DateTime( $value );
						break;

					case WC_Wallee_Entity_Resource_Type::WALLEE_OBJECT:
