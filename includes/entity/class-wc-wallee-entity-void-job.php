 ...
 */
class WC_Wallee_Entity_Void_Job extends WC_Wallee_Entity_Abstract {
	...
	protected static function get_field_definition() {
		return array(
			'void_id' => WC_Wallee_Entity_Resource_Type::WALLEE_INTEGER,
	 ...
	 * @return WC_Wallee_Entity_Void_Job
	 */
