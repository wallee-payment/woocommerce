...
/**
 * Class WC_Wallee_Subscription.
 * This class integrates subscriptions
 *
 * @class WC_Wallee_Subscription
 */
final class WC_Wallee_Subscription {

	/**
	 * The single instance of the class.
	 *
	 * @var WC_Wallee_Subscription
	 */
	 ...
	 *
	 * @return WC_Wallee_Subscription - Main instance.
	 */
	...
	/**
	 * WC_Wallee_Subscription Constructor.
	 */
	...
	public function modify_line_item_method_change( array $line_items, $order ) {
		if ( WC_Subscriptions_Change_Payment_Gateway::$is_request_to_change_payment ) {
			...
			$line_item->setName( __( 'Payment Method Change', 'woo-wallee' ) );
