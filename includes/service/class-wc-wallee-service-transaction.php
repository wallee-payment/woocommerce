...
/**
 *
 * WC_Wallee_Service_Transaction Class
 *
 * Wallee
...
class WC_Wallee_Service_Transaction extends WC_Wallee_Service_Abstract {
	 ...
	 *
	 * @return array|int[]|\Wallee\Sdk\Model\PaymentMethodConfiguration
	...
	protected function getOrderReference( $order ) {
		...
		if ( WC_Wallee_Order_Reference::ORDER_NUMBER == $reference_type ) {
