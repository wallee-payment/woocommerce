...
class WC_Wallee_Service_Token extends WC_Wallee_Service_Abstract {
	...
	protected function update_info( $space_id, TokenVersion $token_version ) {
		...
		$payment_method = WC_Wallee_Entity_Method_Configuration::load_by_configuration(
			$space_id,
	 ...
	 *
	 * @return \Wallee\Sdk\Service\TokenService TokenService.
	 */
