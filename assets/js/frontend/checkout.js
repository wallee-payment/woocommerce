...
jQuery(function ($) {
    var wc_wallee_checkout = {
        ...
        init : function() {
            // Payment methods
            $('form.checkout').off('click.woo-wallee').on(
                'click.woo-wallee',
            ...
            if ($(document.body).hasClass('woocommerce-order-pay')) {
                ...
                $('#order_review').off('click.woo-wallee').on('click.woo-wallee',
                    'input[name="payment_method"]', {
                        self : this
                    }, this.payment_method_click);
            }
        ...
        enable_place_order_button: function(){
            ...
            order_button.removeClass('wallee-disabled');
        },
        
        disable_place_order_button: function(){
            var order_button = $('#place_order');
            order_button.prop('disabled', true);
            order_button.addClass('wallee-disabled');
        },
        ...
        register_method : function(method_id, configuration_id, container_id) {
            ...
            if(this.checkout_form_identifier === '#order_review'){
                $(this.checkout_form_identifier).off('submit.wallee').on(
                    'submit.wallee',
                    function(){
                ...
                form.off('checkout_place_order_' + method_id + '.wallee')
                    .on('checkout_place_order_' + method_id + '.wallee', function(){
                        return self.process_submit(method_id);
                    });
            }
        },
