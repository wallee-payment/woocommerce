...
Additional documentation for this plugin is available [here](https://plugin-documentation.wallee.com/wallee-payment/woocommerce/1.1.12/docs/en/documentation.html).
...
* Feature - Added option to send global product attributes to wallee
